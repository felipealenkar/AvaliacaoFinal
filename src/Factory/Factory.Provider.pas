...
uses
  ...
  // Controllers
  Controller.DbStart, Controller.TipoCultura, Controller.Cultura,
  // Services
  Service.DbStart, Service.TipoCultura, Service.Cultura,
  // Repositories
  Repository.DbStart, Repository.TipoCultura, Repository.Cultura;
